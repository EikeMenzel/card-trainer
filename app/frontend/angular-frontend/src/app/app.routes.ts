...
export const routes: Routes = [
  ...
  {path: 'deck/:deck-id/learn', component: LearnCardViewComponent, canDeactivate: [(component: LearnCardViewComponent) => component.canDestroy()]},
  {path: 'deck/:deck-id/peek', component:PeekCardViewComponent, canDeactivate: [(component: PeekCardViewComponent) => component.canDestroy()]},
